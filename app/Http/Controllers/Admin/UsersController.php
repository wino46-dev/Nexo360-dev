...
class UsersController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.users.index', compact('roles', 'totems', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.users.create', compact('roles',  'totems'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('admin.users.edit', compact('roles',  'totems', 'user'));
    }
    ...
    public function accessSelect(Request $request)
    {
        ...
        return view('admin.users.access_select', compact('users'));
    }
    ...
    public function access(User $user)
    {
        ...
        return view('admin.users.access', compact('user','societies','hotels','selectedSocieties','selectedHotels'));
    }
    ...
    public function accessUpdate(Request $request, User $user)
    {
        ...
        return redirect()->route('admin.users.access', $user->id)->with('status', 'Accesos actualizados correctamente');
    }
}
