...
class ControlErrorController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.controlErrors.index', compact('teams', 'establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.controlErrors.create');
    }
    ...
    public function store(StoreControlErrorRequest $request)
    {
        ...
        return redirect()->route('admin.control-errors.index');
    }
    ...
    public function show(ControlError $controlError)
    {
        ...
        return view('admin.controlErrors.show', compact('controlError'));
    }
