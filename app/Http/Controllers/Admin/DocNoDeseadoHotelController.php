...
class DocNoDeseadoHotelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.docNoDeseadoHotels.index', compact('establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.docNoDeseadoHotels.create', compact('establecimientos'));
    }
    ...
    public function edit(DocNoDeseadoHotel $docNoDeseadoHotel)
    {
        ...
        return view('admin.docNoDeseadoHotels.edit', compact('docNoDeseadoHotel', 'establecimientos'));
    }
    ...
    public function show(DocNoDeseadoHotel $docNoDeseadoHotel)
    {
        ...
        return view('admin.docNoDeseadoHotels.show', compact('docNoDeseadoHotel'));
    }
