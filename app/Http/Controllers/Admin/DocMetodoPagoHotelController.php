...
class DocMetodoPagoHotelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.docMetodoPagoHotels.index', compact('establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.docMetodoPagoHotels.create', compact('establecimientos'));
    }
    ...
    public function edit(DocMetodoPagoHotel $docMetodoPagoHotel)
    {
        ...
        return view('admin.docMetodoPagoHotels.edit', compact('docMetodoPagoHotel', 'establecimientos'));
    }
    ...
    public function show(DocMetodoPagoHotel $docMetodoPagoHotel)
    {
        ...
        return view('admin.docMetodoPagoHotels.show', compact('docMetodoPagoHotel'));
    }
