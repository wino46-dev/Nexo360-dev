...
class ConfiguracionTpvController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.configuracionTpvs.index', compact('totems', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.configuracionTpvs.create', compact('totems'));
    }
    ...
    public function edit(ConfiguracionTpv $configuracionTpv)
    {
        ...
        return view('admin.configuracionTpvs.edit', compact('configuracionTpv'));
    }
    ...
    public function show(ConfiguracionTpv $configuracionTpv)
    {
        ...
        return view('admin.configuracionTpvs.show', compact(['configuracionTpv','totems']));
    }
