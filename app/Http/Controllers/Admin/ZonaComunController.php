...
class ZonaComunController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.zonaComuns.index', compact('establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.zonaComuns.create', compact('establecimientos'));
    }
    ...
    public function store(StoreZonaComunRequest $request)
    {
        ...
        return redirect()->route('admin.zona-comuns.index');
    }
    ...
    public function edit(ZonaComun $zonaComun)
    {
        ...
        return view('admin.zonaComuns.edit', compact('establecimientos', 'zonaComun'));
    }
    ...
    public function show(ZonaComun $zonaComun)
    {
        ...
        return view('admin.zonaComuns.show', compact('zonaComun'));
    }
