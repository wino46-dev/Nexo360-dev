...
class LayoutHomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.layoutHomes.index', compact('teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.layoutHomes.create');
    }
    ...
    public function store(StoreLayoutHomeRequest $request)
    {
        ...
        return redirect()->route('admin.layout-homes.index');
    }
    ...
    public function edit(LayoutHome $layoutHome)
    {
        ...
        return view('admin.layoutHomes.edit', compact('layoutHome'));
    }
    ...
    public function show(LayoutHome $layoutHome)
    {
        ...
        return view('admin.layoutHomes.show', compact('layoutHome'));
    }
