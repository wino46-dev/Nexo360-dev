...
class DockStockHotelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.dockStockHotels.index', compact('doc_ubicacion_hotels'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.dockStockHotels.create', compact('ubicacions'));
    }
    ...
    public function edit(DockStockHotel $dockStockHotel)
    {
        ...
        return view('admin.dockStockHotels.edit', compact('dockStockHotel', 'ubicacions'));
    }
    ...
    public function show(DockStockHotel $dockStockHotel)
    {
        ...
        return view('admin.dockStockHotels.show', compact('dockStockHotel'));
    }
