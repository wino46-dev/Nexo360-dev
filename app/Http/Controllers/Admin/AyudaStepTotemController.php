...
class AyudaStepTotemController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.ayudaStepTotems.index', compact('establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.ayudaStepTotems.create', compact('establecimientos'));
    }
    ...
    public function edit(AyudaStepTotem $ayudaStepTotem)
    {
        ...
        return view('admin.ayudaStepTotems.edit', compact('ayudaStepTotem', 'establecimientos'));
    }
    ...
    public function show(AyudaStepTotem $ayudaStepTotem)
    {
        ...
        return view('admin.ayudaStepTotems.show', compact('ayudaStepTotem'));
    }
