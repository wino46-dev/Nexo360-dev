...
class ClienteController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.clientes.index', compact('pais', 'provincia', 'ciudads', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.clientes.create', compact('ciudads', 'pais', 'provincias'));
    }
    ...
    public function edit(Cliente $cliente)
    {
        ...
        return view('admin.clientes.edit', compact('ciudads', 'cliente', 'pais', 'provincias'));
    }
