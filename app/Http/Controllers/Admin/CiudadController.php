...
class CiudadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.ciudads.index', compact('provincia'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.ciudads.create', compact('provincias'));
    }
    ...
    public function edit(Ciudad $ciudad)
    {
        ...
        return view('admin.ciudads.edit', compact('ciudad', 'provincias'));
    }
    ...
    public function show(Ciudad $ciudad)
    {
        ...
        return view('admin.ciudads.show', compact('ciudad'));
    }
