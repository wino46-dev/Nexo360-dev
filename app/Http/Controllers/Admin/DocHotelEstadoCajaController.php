...
class DocHotelEstadoCajaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.docHotelEstadoCajas.index', compact('establecimientos', 'habitacions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.docHotelEstadoCajas.create', compact('establecimientos', 'rooms'));
    }
    ...
    public function edit(DocHotelEstadoCaja $docHotelEstadoCaja)
    {
        ...
        return view('admin.docHotelEstadoCajas.edit', compact('docHotelEstadoCaja', 'establecimientos', 'rooms'));
    }
    ...
    public function show(DocHotelEstadoCaja $docHotelEstadoCaja)
    {
        ...
        return view('admin.docHotelEstadoCajas.show', compact('docHotelEstadoCaja'));
    }
