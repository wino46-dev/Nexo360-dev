...
class PagoTotemController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.pagoTotems.index', compact('users', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.pagoTotems.create', compact('emisors', 'receptors', 'sesions'));
    }
    ...
    public function edit(PagoTotem $pagoTotem)
    {
        ...
        return view('admin.pagoTotems.edit', compact('emisors', 'pagoTotem', 'receptors'));
    }
    ...
    public function update(UpdatePagoTotemRequest $request, PagoTotem $pagoTotem)
    {
        ...
        return redirect()->route('admin.pago-totems.index');
    }
    ...
    public function show(PagoTotem $pagoTotem)
    {
        ...
        return view('admin.pagoTotems.show', compact('pagoTotem'));
    }
