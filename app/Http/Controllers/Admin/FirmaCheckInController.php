...
class FirmaCheckInController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.firmaCheckIns.index', compact('control_sesions', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.firmaCheckIns.create', compact('sesions'));
    }
    ...
    public function store(StoreFirmaCheckInRequest $request)
    {
        ...
        return redirect()->route('admin.firma-check-ins.index');
    }
    ...
    public function edit(FirmaCheckIn $firmaCheckIn)
    {
        ...
        return view('admin.firmaCheckIns.edit', compact('firmaCheckIn'));
    }
    ...
    public function show(FirmaCheckIn $firmaCheckIn)
    {
        ...
        return view('admin.firmaCheckIns.show', compact('firmaCheckIn'));
    }
