...
class SociedadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.sociedads.index', compact('teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.sociedads.create');
    }
    ...
    public function store(StoreSociedadRequest $request)
    {
        ...
        return redirect()->route('admin.sociedads.index');
    }
    ...
    public function edit(Sociedad $sociedad)
    {
        ...
        return view('admin.sociedads.edit', compact('sociedad'));
    }
    ...
    public function show(Sociedad $sociedad)
    {
        ...
        return view('admin.sociedads.show', compact('sociedad'));
    }
