...
class GrabacionTarjetaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.grabacionTarjeta.index', compact('users', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.grabacionTarjeta.create', compact('emisors', 'receptors', 'sesions'));
    }
    ...
    public function edit(GrabacionTarjetum $grabacionTarjetum)
    {
        ...
        return view('admin.grabacionTarjeta.edit', compact('emisors', 'grabacionTarjetum', 'receptors', 'sesions'));
    }
    ...
    public function update(UpdateGrabacionTarjetumRequest $request, GrabacionTarjetum $grabacionTarjetum)
    {
        ...
        return redirect()->route('admin.grabacion-tarjeta.index');
    }
    ...
    public function show(GrabacionTarjetum $grabacionTarjetum)
    {
        ...
        return view('admin.grabacionTarjeta.show', compact('grabacionTarjetum'));
    }
