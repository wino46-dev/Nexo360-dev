...
class EstablecimientoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.establecimientos.index', compact('sociedads'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.establecimientos.create', compact('sociedads', 'proveedorCerraduraList', 'pms_list'));
    }
    ...
    public function show(Establecimiento $establecimiento)
    {
        ...
        if (isset($ayudaStepTotem->id)) {
            ...
            $ayudaStepTotem;
            return view('admin.establecimientos.show', compact('establecimiento', 'establecimientos', 'ayudaStepTotem'));
        } else {
            return view('admin.establecimientos.show', compact('establecimiento', 'establecimientos'));
        }
    }
    ...
    public function partesConfig($id)
    {
        ...
        return view('admin.establecimientos._partes_form', compact('establecimiento'));
    }
