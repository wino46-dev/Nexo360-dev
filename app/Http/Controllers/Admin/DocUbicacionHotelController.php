...
class DocUbicacionHotelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.docUbicacionHotels.index', compact('establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.docUbicacionHotels.create', compact('establecimientos'));
    }
    ...
    public function edit(DocUbicacionHotel $docUbicacionHotel)
    {
        ...
        return view('admin.docUbicacionHotels.edit', compact('docUbicacionHotel', 'establecimientos'));
    }
    ...
    public function show(DocUbicacionHotel $docUbicacionHotel)
    {
        ...
        return view('admin.docUbicacionHotels.show', compact('docUbicacionHotel'));
    }
