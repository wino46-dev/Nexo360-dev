...
class DocHabitacionHotelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.docHabitacionHotels.index', compact('establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.docHabitacionHotels.create', compact('establecimientos'));
    }
    ...
    public function edit(DocHabitacionHotel $docHabitacionHotel)
    {
        ...
        return view('admin.docHabitacionHotels.edit', compact('docHabitacionHotel', 'establecimientos'));
    }
    ...
    public function show(DocHabitacionHotel $docHabitacionHotel)
    {
        ...
        return view('admin.docHabitacionHotels.show', compact('docHabitacionHotel'));
    }
