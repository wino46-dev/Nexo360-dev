...
class ParteViajeroController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.parteViajeros.index', compact('reservas', 'clientes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.parteViajeros.create', compact('clientes', 'reservas'));
    }
    ...
    public function store(StoreParteViajeroRequest $request)
    {
        ...
        return redirect()->route('admin.parte-viajeros.index');
    }
    ...
    public function edit(ParteViajero $parteViajero)
    {
        ...
        return view('admin.parteViajeros.edit', compact('clientes', 'parteViajero', 'reservas'));
    }
    ...
    public function show(ParteViajero $parteViajero)
    {
        ...
        return view('admin.parteViajeros.show', compact('parteViajero'));
    }
