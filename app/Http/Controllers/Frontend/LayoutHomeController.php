...
class LayoutHomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $layoutHomes = LayoutHome::with(['media'])->get();



        return view('frontend.layoutHomes.index', compact('layoutHomes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.layoutHomes.create');
    }
    ...
    public function store(StoreLayoutHomeRequest $request)
    {
        ...
        return redirect()->route('frontend.layout-homes.index');
    }
    ...
    public function edit(LayoutHome $layoutHome)
    {
        ...
        return view('frontend.layoutHomes.edit', compact('layoutHome'));
    }
    ...
    public function show(LayoutHome $layoutHome)
    {
        ...
        return view('frontend.layoutHomes.show', compact('layoutHome'));
    }
