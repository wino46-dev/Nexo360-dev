...
class RespuestaEventoHomeTotemController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('external.respuestaEventoHomeTotems.index', compact('evento_home_totems', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('external.respuestaEventoHomeTotems.create', compact('eventos'));
    }
    ...
    public function store(StoreRespuestaEventoHomeTotemRequest $request)
    {
        ...
        return redirect()->route('external.respuesta-evento-home-totems.index');
    }
    ...
    public function edit(RespuestaEventoHomeTotem $respuestaEventoHomeTotem)
    {
        ...
        return view('external.respuestaEventoHomeTotems.edit', compact('eventos', 'respuestaEventoHomeTotem'));
    }
    ...
    public function show(RespuestaEventoHomeTotem $respuestaEventoHomeTotem)
    {
        ...
        return view('external.respuestaEventoHomeTotems.show', compact('respuestaEventoHomeTotem'));
    }
