...
class DocHotelReceptionInfoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('external.docHotelReceptionInfos.index', compact('establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('external.docHotelReceptionInfos.create', compact('establecimientos'));
    }
    ...
    public function store(StoreDocHotelReceptionInfoRequest $request)
    {
        ...
        return redirect()->route('external.landing_wiki_hotel');
    ...
    public function edit(DocHotelReceptionInfo $docHotelReceptionInfo)
    {
        ...
        return view('external.docHotelReceptionInfos.edit', compact('docHotelReceptionInfo', 'establecimientos'));
    }
    ...
    public function show(DocHotelReceptionInfo $docHotelReceptionInfo)
    {
        ...
        return view('external.docHotelReceptionInfos.show', compact('docHotelReceptionInfo'));
    }
