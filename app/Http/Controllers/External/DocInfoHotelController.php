...
class DocInfoHotelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('external.docInfoHotels.index', compact('establecimientos', 'pais', 'provincia', 'ciudads'));
    }
    ...
    public function create()
    {
        ...
        return view('external.docInfoHotels.create', compact('ciudads', 'hotels', 'pais', 'provincias'));
    }
    ...
    public function edit(DocInfoHotel $docInfoHotel)
    {
        ...
        return view('external.docInfoHotels.edit', compact('ciudads', 'docInfoHotel', 'hotels', 'pais', 'provincias'));
    }
    ...
    public function show(DocInfoHotel $docInfoHotel)
    {
        ...
        return view('external.docInfoHotels.show', compact('docInfoHotel'));
    }
