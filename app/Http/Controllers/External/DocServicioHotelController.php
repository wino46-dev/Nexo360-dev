...
class DocServicioHotelController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('external.docServicioHotels.index', compact('establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('external.docServicioHotels.create', compact('hotels'));
    }
    ...
    public function edit(DocServicioHotel $docServicioHotel)
    {
        ...
        return view('external.docServicioHotels.edit', compact('docServicioHotel', 'hotels'));
    }
    ...
    public function show(DocServicioHotel $docServicioHotel)
    {
        ...
        return view('external.docServicioHotels.show', compact('docServicioHotel'));
    }
