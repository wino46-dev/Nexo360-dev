...
class LandingWikiHotelController extends Controller
{
    public function index()
    {
        ...
        // Use the existing external landing view; External URL rewriter and route helpers make it panel-aware
        return view('external.landingWikiHotel.index', compact('establecimientos','defaultEstablecimientoId','defaultEstablecimientoCodigo','hasActiveControlSesion','panelPrefix'));
    }
}
