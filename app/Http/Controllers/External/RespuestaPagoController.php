...
class RespuestaPagoController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('external.respuestaPagos.index', compact('pago_totems', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('external.respuestaPagos.create', compact('pago_origens'));
    }
    ...
    public function store(StoreRespuestaPagoRequest $request)
    {
        ...
        return redirect()->route('external.respuesta-pagos.index');
    }
    ...
    public function edit(RespuestaPago $respuestaPago)
    {
        ...
        return view('external.respuestaPagos.edit', compact('pago_origens', 'respuestaPago'));
    }
    ...
    public function show(RespuestaPago $respuestaPago)
    {
        ...
        return view('external.respuestaPagos.show', compact('respuestaPago'));
    }
