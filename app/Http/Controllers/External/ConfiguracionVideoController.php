...
class ConfiguracionVideoController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('external.configuracionVideos.index', compact('totems', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('external.configuracionVideos.create', compact('totems'));
    }
    ...
    public function store(StoreConfiguracionVideoRequest $request)
    {
        ...
        return redirect()->route('external.configuracion-videos.index');
    }
    ...
    public function edit(ConfiguracionVideo $configuracionVideo)
    {
        ...
        return view('external.configuracionVideos.edit', compact('configuracionVideo', 'totems'));
    }
    ...
    public function show(ConfiguracionVideo $configuracionVideo)
    {
        ...
        return view('external.configuracionVideos.show', compact('configuracionVideo'));
    }
}
