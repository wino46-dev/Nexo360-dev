...
class TotemController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('external.totems.index', compact('establecimientos', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('external.totems.create', compact('establecimientos'));
    }
    ...
    public function store(StoreTotemRequest $request)
    {
        ...
        return redirect()->route('external.totems.index');
    }
    ...
    public function edit(Totem $totem)
    {
        ...
        return view('external.totems.edit', compact('establecimientos', 'totem'));
    }
    ...
    public function show(Totem $totem)
    {
        ...
        return view('external.totems.show', compact(['totem','configuracionTpv','configuracionVideo','configuracionGrabador']));
    }
