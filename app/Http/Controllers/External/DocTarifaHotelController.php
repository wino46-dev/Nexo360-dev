...
class DocTarifaHotelController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('external.docTarifaHotels.index', compact('establecimientos', 'doc_habitacion_hotels'));
    }
    ...
    public function create()
    {
        ...
        return view('external.docTarifaHotels.create', compact('establecimientos', 'habitacions'));
    }
    ...
    public function edit(DocTarifaHotel $docTarifaHotel)
    {
        ...
        return view('external.docTarifaHotels.edit', compact('docTarifaHotel', 'establecimientos', 'habitacions'));
    }
    ...
    public function show(DocTarifaHotel $docTarifaHotel)
    {
        ...
        return view('external.docTarifaHotels.show', compact('docTarifaHotel'));
    }
