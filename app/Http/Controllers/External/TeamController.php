...
class TeamController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('external.teams.index', compact('users'));
    }
    ...
    public function create()
    {
        ...
        return view('external.teams.create');
    }
    ...
    public function store(StoreTeamRequest $request)
    {
        ...
        return redirect()->route('external.teams.index');
    }
    ...
    public function edit(Team $team)
    {
        ...
        return view('external.teams.edit', compact('team'));
    }
    ...
    public function show(Team $team)
    {
        ...
        return view('external.teams.show', compact('team'));
    }
