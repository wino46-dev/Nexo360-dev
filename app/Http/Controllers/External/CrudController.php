...
class CrudController extends Controller
{
    ...
    public function setConfig(array $config)
    {
        ...
        $this->config['list_view'] = $this->config['list_view'] ?? 'external.crud.list';
        $this->config['list_js_view'] = $this->config['list_js_view'] ?? 'external.crud.list_js';
        $this->config['create_view'] = $this->config['create_view'] ?? 'external.crud.create';
        $this->config['edit_view'] = $this->config['edit_view'] ?? 'external.crud.edit';
    ...
    public function index(Request $request)
    {
        ...
        return view('external.crud.index', ['config' => $this->config]);
    }
    ...
    protected function addDefaultColumns($table)
    {
        ...
        $table->editColumn('actions', function ($row) {
            ...
            return view('external.crud.datatablesActions', compact('viewGate', 'editGate', 'deleteGate', 'row'));
        });
    }
    ...
    public function edit($id)
    {
        ...
        //return view('external.' . $this->config['id'] . '.edit', compact('model'));
    }
    ...
    public function parseCsvImport(Request $request)
    {
        ...
        return view(
            'external.crud.csvImport.parseInput',
