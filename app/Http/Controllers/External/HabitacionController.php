...
class HabitacionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('external.habitacions.index', compact('establecimientos', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('external.habitacions.create', compact('establecimientos'));
    }
    ...
    public function store(StoreHabitacionRequest $request)
    {
        ...
        return redirect()->route('external.habitacions.index');
    }
    ...
    public function edit(Habitacion $habitacion)
    {
        ...
        return view('external.habitacions.edit', compact('establecimientos', 'habitacion'));
    }
    ...
    public function show(Habitacion $habitacion)
    {
        ...
        return view('external.habitacions.show', compact('habitacion'));
    }
