...
class DocIncidenciaHotelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('external.docIncidenciaHotels.index', compact('establecimientos'));
    }
    ...
    public function create()
    {
        ...
        return view('external.docIncidenciaHotels.create', compact('establecimientos'));
    }
    ...
    public function edit(DocIncidenciaHotel $docIncidenciaHotel)
    {
        ...
        return view('external.docIncidenciaHotels.edit', compact('docIncidenciaHotel', 'establecimientos'));
    }
    ...
    public function show(DocIncidenciaHotel $docIncidenciaHotel)
    {
        ...
        return view('external.docIncidenciaHotels.show', compact('docIncidenciaHotel'));
    }
