...
class ConfiguracionGrabadorController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('external.configuracionGrabadors.index', compact('totems', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('external.configuracionGrabadors.create', compact('totems'));
    }
    ...
    public function store(StoreConfiguracionGrabadorRequest $request)
    {
        ...
        return redirect()->route('external.configuracion-grabadors.index');
    }
    ...
    public function edit(ConfiguracionGrabador $configuracionGrabador)
    {
        ...
        return view('external.configuracionGrabadors.edit', compact('configuracionGrabador', 'totems'));
    }
    ...
    public function show(ConfiguracionGrabador $configuracionGrabador)
    {
        ...
        return view('external.configuracionGrabadors.show', compact('configuracionGrabador'));
    }
