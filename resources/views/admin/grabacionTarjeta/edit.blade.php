...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.grabacionTarjetum.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.grabacion-tarjeta.update", [$grabacionTarjetum->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('emisor') ? 'is-invalid' : '' }}" name="emisor_id" id="emisor_id" required>
                    @foreach($emisors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('emisor_id') ? old('emisor_id') : $grabacionTarjetum->emisor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('receptor') ? 'is-invalid' : '' }}" name="receptor_id" id="receptor_id" required>
                    @foreach($receptors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('receptor_id') ? old('receptor_id') : $grabacionTarjetum->receptor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('sesion') ? 'is-invalid' : '' }}" name="sesion_id" id="sesion_id">
                    @foreach($sesions as $id => $entry)
                        <option value="{{ $id }}" {{ (old('sesion_id') ? old('sesion_id') : $grabacionTarjetum->sesion->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_in') ? 'is-invalid' : '' }}" type="text" name="date_in" id="date_in" value="{{ old('date_in', $grabacionTarjetum->date_in) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_in') ? 'is-invalid' : '' }}" type="text" name="time_in" id="time_in" value="{{ old('time_in', $grabacionTarjetum->time_in) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_out') ? 'is-invalid' : '' }}" type="text" name="date_out" id="date_out" value="{{ old('date_out', $grabacionTarjetum->date_out) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_out') ? 'is-invalid' : '' }}" type="text" name="time_out" id="time_out" value="{{ old('time_out', $grabacionTarjetum->time_out) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('room_no') ? 'is-invalid' : '' }}" type="number" name="room_no" id="room_no" value="{{ old('room_no', $grabacionTarjetum->room_no) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('room_no_2') ? 'is-invalid' : '' }}" type="number" name="room_no_2" id="room_no_2" value="{{ old('room_no_2', $grabacionTarjetum->room_no_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('room_no_3') ? 'is-invalid' : '' }}" type="number" name="room_no_3" id="room_no_3" value="{{ old('room_no_3', $grabacionTarjetum->room_no_3) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('safe_box') ? 'is-invalid' : '' }}" type="text" name="safe_box" id="safe_box" value="{{ old('safe_box', $grabacionTarjetum->safe_box) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('common_doors') ? 'is-invalid' : '' }}" name="common_doors" id="common_doors">{{ old('common_doors', $grabacionTarjetum->common_doors) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('card_qty') ? 'is-invalid' : '' }}" type="number" name="card_qty" id="card_qty" value="{{ old('card_qty', $grabacionTarjetum->card_qty) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uid_card') ? 'is-invalid' : '' }}" type="text" name="uid_card" id="uid_card" value="{{ old('uid_card', $grabacionTarjetum->uid_card) }}" required>
