...
<div class="card mt-2" id="result_edit_app">
    ...
    @include('admin.reservas.edit._folio_modal')
</div>
    ...
    var editApp = new Vue({
        ...
        methods: {
            ...
            folio_edit(folio) {
                ...
                $.ajax({
                    url: '{{ url('admin/reservas/folio-edit') }}',
                    method: 'POST',
                    headers: {
            ...
            folio_client_save(form) {
                ...
                $.ajax({
                    url: '{{ url('admin/reservas/folio-update') }}',
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('input[name="_token"]').val()
                    },
            ...
            reservation_save(form) {
                ...
                $.ajax({
                    url: '{{ url('admin/reservas/reservation-update') }}',
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': $('input[name="_token"]').val()
                    },
            ...
            reservation_new_save() {
                ...
                $.ajax({
                    url: '{{ url('admin/reservas/reservation-add') }}',
                    method: 'POST',
                    cache: false,
                    headers: {
                        'X-CSRF-TOKEN': $('input[name="_token"]').val()
