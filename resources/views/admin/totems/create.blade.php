...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.totem.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.totems.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('fuente_imagenes_pagina_1') ? 'is-invalid' : '' }}" name="fuente_imagenes_pagina_1" id="fuente_imagenes_pagina_1" required>
                            ...
                            @foreach(App\Models\Totem::FUENTE_IMAGENES_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('fuente_imagenes_pagina_1', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('texto_superior_pagina_1') ? 'is-invalid' : '' }}" name="texto_superior_pagina_1" id="texto_superior_pagina_1">{{ old('texto_superior_pagina_1', '') }}</textarea>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('pagina_llamada_texto_superior') ? 'is-invalid' : '' }}" name="pagina_llamada_texto_superior" id="pagina_llamada_texto_superior">{{ old('pagina_llamada_texto_superior', '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('pagina_llamada_texto_inferior') ? 'is-invalid' : '' }}" name="pagina_llamada_texto_inferior" id="pagina_llamada_texto_inferior">{{ old('pagina_llamada_texto_inferior', '') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('pagina_llamada_texto_boton') ? 'is-invalid' : '' }}" name="pagina_llamada_texto_boton" id="pagina_llamada_texto_boton" style="min-height:30px !important">{{ old('pagina_llamada_texto_boton', '') }}</textarea>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="form-check {{ $errors->has('mostrar_pagina_2') ? 'is-invalid' : '' }}">
                            ...
                            <input class="form-check-input" type="checkbox" name="mostrar_pagina_2" id="mostrar_pagina_2" value="1" {{ old('mostrar_pagina_2', 0) == 1 ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('texto_superior_pagina_2') ? 'is-invalid' : '' }}" type="text" name="texto_superior_pagina_2" id="texto_superior_pagina_2" value="{{ old('texto_superior_pagina_2', '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('texto_inferior_pagina_2') ? 'is-invalid' : '' }}" type="text" name="texto_inferior_pagina_2" id="texto_inferior_pagina_2" value="{{ old('texto_inferior_pagina_2', '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('fuente_spinner') ? 'is-invalid' : '' }}" name="fuente_spinner" id="fuente_spinner">
                            ...
                            @foreach(App\Models\Totem::FUENTE_SPINNER_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('fuente_spinner', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('fuente_imagenes') ? 'is-invalid' : '' }}" name="fuente_imagenes" id="fuente_imagenes" required>
                            ...
                            @foreach(App\Models\Totem::FUENTE_IMAGENES_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('fuente_imagenes', 'Totem') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
