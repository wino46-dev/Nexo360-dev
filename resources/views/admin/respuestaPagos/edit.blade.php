...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.respuestaPago.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.respuesta-pagos.update", [$respuestaPago->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('pago_origen') ? 'is-invalid' : '' }}" name="pago_origen_id" id="pago_origen_id" required>
                    @foreach($pago_origens as $id => $entry)
                        <option value="{{ $id }}" {{ (old('pago_origen_id') ? old('pago_origen_id') : $respuestaPago->pago_origen->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipo_pago') ? 'is-invalid' : '' }}" type="text" name="tipo_pago" id="tipo_pago" value="{{ old('tipo_pago', $respuestaPago->tipo_pago) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipo_oper') ? 'is-invalid' : '' }}" type="text" name="tipo_oper" id="tipo_oper" value="{{ old('tipo_oper', $respuestaPago->tipo_oper) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('importe') ? 'is-invalid' : '' }}" type="number" name="importe" id="importe" value="{{ old('importe', $respuestaPago->importe) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('moneda') ? 'is-invalid' : '' }}" type="text" name="moneda" id="moneda" value="{{ old('moneda', $respuestaPago->moneda) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tarjeta_comercio_recibo') ? 'is-invalid' : '' }}" type="text" name="tarjeta_comercio_recibo" id="tarjeta_comercio_recibo" value="{{ old('tarjeta_comercio_recibo', $respuestaPago->tarjeta_comercio_recibo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tarjeta_cliente_recibo') ? 'is-invalid' : '' }}" type="text" name="tarjeta_cliente_recibo" id="tarjeta_cliente_recibo" value="{{ old('tarjeta_cliente_recibo', $respuestaPago->tarjeta_cliente_recibo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marca_tarjeta') ? 'is-invalid' : '' }}" type="email" name="marca_tarjeta" id="marca_tarjeta" value="{{ old('marca_tarjeta', $respuestaPago->marca_tarjeta) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('caducidad') ? 'is-invalid' : '' }}" type="text" name="caducidad" id="caducidad" value="{{ old('caducidad', $respuestaPago->caducidad) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comercio') ? 'is-invalid' : '' }}" type="text" name="comercio" id="comercio" value="{{ old('comercio', $respuestaPago->comercio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('terminal') ? 'is-invalid' : '' }}" type="text" name="terminal" id="terminal" value="{{ old('terminal', $respuestaPago->terminal) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tarjeta') ? 'is-invalid' : '' }}" type="text" name="tarjeta" id="tarjeta" value="{{ old('tarjeta', $respuestaPago->tarjeta) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identificador_rts_base') ? 'is-invalid' : '' }}" type="text" name="identificador_rts_base" id="identificador_rts_base" value="{{ old('identificador_rts_base', $respuestaPago->identificador_rts_base) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pedido') ? 'is-invalid' : '' }}" type="text" name="pedido" id="pedido" value="{{ old('pedido', $respuestaPago->pedido) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipo_tasa_aplicada') ? 'is-invalid' : '' }}" type="text" name="tipo_tasa_aplicada" id="tipo_tasa_aplicada" value="{{ old('tipo_tasa_aplicada', $respuestaPago->tipo_tasa_aplicada) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identificador_rts') ? 'is-invalid' : '' }}" type="text" name="identificador_rts" id="identificador_rts" value="{{ old('identificador_rts', $respuestaPago->identificador_rts) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('factura') ? 'is-invalid' : '' }}" type="text" name="factura" id="factura" value="{{ old('factura', $respuestaPago->factura) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fecha_operacion') ? 'is-invalid' : '' }}" type="text" name="fecha_operacion" id="fecha_operacion" value="{{ old('fecha_operacion', $respuestaPago->fecha_operacion) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" type="text" name="estado" id="estado" value="{{ old('estado', $respuestaPago->estado) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resultado') ? 'is-invalid' : '' }}" type="text" name="resultado" id="resultado" value="{{ old('resultado', $respuestaPago->resultado) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codigo_respuesta') ? 'is-invalid' : '' }}" type="text" name="codigo_respuesta" id="codigo_respuesta" value="{{ old('codigo_respuesta', $respuestaPago->codigo_respuesta) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('literales') ? 'is-invalid' : '' }}" name="literales" id="literales">{{ old('literales', $respuestaPago->literales) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('firma') ? 'is-invalid' : '' }}" name="firma" id="firma">{{ old('firma', $respuestaPago->firma) }}</textarea>
                @if($errors->has('firma'))
                    <div class="invalid-feedback">
                        {{ $errors->first('firma') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('operacionemv') ? 'is-invalid' : '' }}" type="text" name="operacionemv" id="operacionemv" value="{{ old('operacionemv', $respuestaPago->operacionemv) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conttrans') ? 'is-invalid' : '' }}" type="text" name="conttrans" id="conttrans" value="{{ old('conttrans', $respuestaPago->conttrans) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sectarjeta') ? 'is-invalid' : '' }}" type="text" name="sectarjeta" id="sectarjeta" value="{{ old('sectarjeta', $respuestaPago->sectarjeta) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('idapp') ? 'is-invalid' : '' }}" type="text" name="idapp" id="idapp" value="{{ old('idapp', $respuestaPago->idapp) }}">
                @if($errors->has('idapp'))
                    <div class="invalid-feedback">
                        {{ $errors->first('idapp') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codrespauto') ? 'is-invalid' : '' }}" type="text" name="codrespauto" id="codrespauto" value="{{ old('codrespauto', $respuestaPago->codrespauto) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resverificacion') ? 'is-invalid' : '' }}" type="text" name="resverificacion" id="resverificacion" value="{{ old('resverificacion', $respuestaPago->resverificacion) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('version') ? 'is-invalid' : '' }}" type="text" name="version" id="version" value="{{ old('version', $respuestaPago->version) }}">
