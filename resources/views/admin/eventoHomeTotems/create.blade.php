...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.evento-home-totems.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('canal_transmision') ? 'is-invalid' : '' }}" name="canal_transmision" id="canal_transmision">
