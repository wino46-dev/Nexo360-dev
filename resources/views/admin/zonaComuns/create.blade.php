...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.zonaComun.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.zona-comuns.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <input class="form-control {{ $errors->has('orden') ? 'is-invalid' : '' }}" type="number" name="orden" id="orden" value="{{ old('orden', '') }}">
                    @if($errors->has('orden'))
                        <div class="invalid-feedback">
                            {{ $errors->first('orden') }}
                        </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('global') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="global" id="global" value="1" {{ old('global', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('estado') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="estado" id="estado" value="1" {{ old('estado', 0) == 1 || old('estado') === null ? 'checked' : '' }}>
