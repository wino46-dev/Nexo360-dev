<?php 
if($config['import_type'] == 'parse'){
    $url_import = $config['url'] .'/parse-csv-import';
}elseif($config['import_type'] == 'direct'){
    $url_import = $config['url'] .'/process-csv-import';
}else{
    echo 'No se definio "import_type"'; die;
}
?>
            ...
            <div class="modal-body text-left">
                <div class='row'>
                    <div class='col-md-12'>
                        ...
                        <form class="form-horizontal" method="POST" action="{{ $url_import }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
