...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.doc-habitacion-hotels.index') }}">
...
<div class="card">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="habitacion_doc_tarifa_hotels">
            @includeIf('admin.docHabitacionHotels.relationships.habitacionDocTarifaHotels', ['docTarifaHotels' => $docHabitacionHotel->habitacionDocTarifaHotels])
        </div>
    </div>
</div>
