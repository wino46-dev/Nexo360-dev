...
@can('doc_habitacion_hotel_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.doc-habitacion-hotels.create') }}">
...
@can('doc_habitacion_hotel_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.doc-habitacion-hotels.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.doc-habitacion-hotels.index') }}",
    columns: [
