...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.layoutHome.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.layout-homes.update", [$layoutHome->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tipo') ? 'is-invalid' : '' }}" name="tipo" id="tipo">
                    ...
                    @foreach(App\Models\LayoutHome::TIPO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tipo', $layoutHome->tipo) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('tipo'))
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('imagen_1') ? 'is-invalid' : '' }}" id="imagen_1-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('imagen_2') ? 'is-invalid' : '' }}" id="imagen_2-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('imagen_3') ? 'is-invalid' : '' }}" id="imagen_3-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('imagen_4') ? 'is-invalid' : '' }}" id="imagen_4-dropzone">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('imagen_5') ? 'is-invalid' : '' }}" id="imagen_5-dropzone">
                </div>
...
<script>
    ...
    url: '{{ route('admin.layout-homes.storeMedia') }}',
    maxFilesize: 2, // MB
