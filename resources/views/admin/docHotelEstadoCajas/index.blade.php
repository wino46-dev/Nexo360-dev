...
@can('doc_hotel_estado_caja_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.doc-hotel-estado-cajas.create') }}">
...
@can('doc_hotel_estado_caja_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.doc-hotel-estado-cajas.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.doc-hotel-estado-cajas.index') }}",
    columns: [
