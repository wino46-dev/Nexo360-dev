...
@can('doc_ubicacion_hotel_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.doc-ubicacion-hotels.create') }}">
...
@can('doc_ubicacion_hotel_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.doc-ubicacion-hotels.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.doc-ubicacion-hotels.index') }}",
    columns: [
