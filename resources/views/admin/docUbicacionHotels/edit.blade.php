...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.doc-ubicacion-hotels.update", [$docUbicacionHotel->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre" id="nombre" value="{{ old('nombre', $docUbicacionHotel->nombre) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('piso') ? 'is-invalid' : '' }}" type="number" name="piso" id="piso" value="{{ old('piso', $docUbicacionHotel->piso) }}" step="1">
                @if($errors->has('piso'))
                    <div class="invalid-feedback">
                        {{ $errors->first('piso') }}
                    </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('zona_comun') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="zona_comun" id="zona_comun" value="1" {{ $docUbicacionHotel->zona_comun || old('zona_comun', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('comentarios') ? 'is-invalid' : '' }}" name="comentarios" id="comentarios">{!! old('comentarios', $docUbicacionHotel->comentarios) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.doc-ubicacion-hotels.storeCKEditorImages') }}', true);
