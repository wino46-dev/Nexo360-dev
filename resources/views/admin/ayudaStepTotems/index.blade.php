...
@can('ayuda_step_totem_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.ayuda-step-totems.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AyudaStepTotem">
            <thead>
                <tr>
                    <th width="10">
...
@can('ayuda_step_totem_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.ayuda-step-totems.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.ayuda-step-totems.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-AyudaStepTotem').DataTable(dtOverrideGlobals);
