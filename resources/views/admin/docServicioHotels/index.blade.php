...
@can('doc_servicio_hotel_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.doc-servicio-hotels.create') }}">
...
@can('doc_servicio_hotel_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.doc-servicio-hotels.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.doc-servicio-hotels.index') }}",
    columns: [
