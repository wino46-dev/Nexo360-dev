...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.doc-info-hotels.update", [$docInfoHotel->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.doc-info-hotels.storeCKEditorImages') }}', true);
