...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.doc-hotel-reception-infos.store') }}" enctype="multipart/form-data">
            @csrf
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open("POST", "{{ route('admin.doc-hotel-reception-infos.storeCKEditorImages') }}", true);
