...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.doc-hotel-reception-infos.update', [$docHotelReceptionInfo->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route($panelPrefix . '.doc-hotel-reception-infos.storeCKEditorImages') }}', true);
...
Dropzone.options.boxPhotoDropzone = {
    url: '{{ route('admin.doc-hotel-reception-infos.storeMedia') }}',
    maxFilesize: 4, // MB
