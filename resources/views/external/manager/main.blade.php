        ...
        <div class="form">
            ...
            <div class="right-side">
                ...
                <div id="divpushli" class="main active">
                    ...
                    <br><br>
                    @include('external.manager.create')
                    <br><br>
                ...
                <div id="divimagesli" class="main">
                    <div class="text">
                        ...
                        @include('external.manager.galeryTour')
                ...
                <div id="divcapturasli" class="main">
                    <div class="text">
                        ...
                        @include('external.manager.capturePhoto')
                    </div>
                ...
                <div id="divpagosli" class="main">
                    ...
                    <br>
                    @include('external.manager.payment')
                    <br>
                ...
                <div id="divcardsli" class="main">
                    ...
                    <br><br>
                    @include('external.manager.writeCard')
                    <br>
                ...
                <div id="divsingsli" class="main">
                    ...
                    @include('external.manager.captureSign')
