...
@can('doc_ubicacion_hotel_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('external.doc-ubicacion-hotels.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-DocUbicacionHotel">
            <thead>
                <tr>
                    <th width="10">
...
@can('doc_ubicacion_hotel_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('external.doc-ubicacion-hotels.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('external.doc-ubicacion-hotels.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-DocUbicacionHotel').DataTable(dtOverrideGlobals);
