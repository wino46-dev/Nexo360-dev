...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.docNoDeseadoHotel.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("external.doc-no-deseado-hotels.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fecha') ? 'is-invalid' : '' }}" type="datetime-local" id="fecha_dt">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('datos_cliente') ? 'is-invalid' : '' }}" name="datos_cliente" id="datos_cliente">{!! old('datos_cliente') !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('no_deseado') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="no_deseado" id="no_deseado" value="1" {{ old('no_deseado', 0) == 1 ? 'checked' : '' }}>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('external.doc-no-deseado-hotels.storeCKEditorImages') }}', true);
