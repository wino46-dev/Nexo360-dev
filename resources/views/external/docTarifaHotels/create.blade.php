...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("external.doc-tarifa-hotels.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tarifa') ? 'is-invalid' : '' }}" type="text" name="tarifa" id="tarifa" value="{{ old('tarifa', '') }}" required>
