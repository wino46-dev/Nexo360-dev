...
@can('doc_incidencia_hotel_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('external.doc-incidencia-hotels.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-DocIncidenciaHotel">
            <thead>
                <tr>
                    <th width="10">
...
@can('doc_incidencia_hotel_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('external.doc-incidencia-hotels.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('external.doc-incidencia-hotels.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-DocIncidenciaHotel').DataTable(dtOverrideGlobals);
