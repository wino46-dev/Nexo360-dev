...
@can('doc_hotel_reception_info_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('external.doc-hotel-reception-infos.create') }}">
...
@can('doc_hotel_reception_info_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('external.doc-hotel-reception-infos.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('external.doc-hotel-reception-infos.index') }}",
    columns: [
