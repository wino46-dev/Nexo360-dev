...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.docHotelReceptionInfo.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route('external.doc-hotel-reception-infos.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('hour_open') ? 'is-invalid' : '' }}" type="text" name="hour_open" id="hour_open" value="{{ old('hour_open') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('hour_close') ? 'is-invalid' : '' }}" type="text" name="hour_close" id="hour_close" value="{{ old('hour_close') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('open_holiday') ? 'is-invalid' : '' }}" type="text" name="open_holiday" id="open_holiday" value="{{ old('open_holiday') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('close_holiday') ? 'is-invalid' : '' }}" type="text" name="close_holiday" id="close_holiday" value="{{ old('close_holiday') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('acces_type_after_hour') ? 'is-invalid' : '' }}" name="acces_type_after_hour" id="acces_type_after_hour">
                    ...
                    @foreach(App\Models\DocHotelReceptionInfo::ACCES_TYPE_AFTER_HOUR_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('acces_type_after_hour', 'Tarjeta') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('box_locate') ? 'is-invalid' : '' }}" name="box_locate" id="box_locate">{!! old('box_locate') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('acces_videoportero') ? 'is-invalid' : '' }}" name="acces_videoportero" id="acces_videoportero">{!! old('acces_videoportero') !!}</textarea>
