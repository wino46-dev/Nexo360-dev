...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('external.doc-hotel-reception-infos.update', [$docHotelReceptionInfo->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="establecimiento_id">{{ trans('cruds.docHotelReceptionInfo.fields.establecimiento') }}</label>
                <select class="form-control select2 {{ $errors->has('establecimiento') ? 'is-invalid' : '' }}" name="establecimiento_id" id="establecimiento_id">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('hour_open') ? 'is-invalid' : '' }}" type="text" name="hour_open" id="hour_open" value="{{ old('hour_open', $docHotelReceptionInfo->hour_open) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('hour_close') ? 'is-invalid' : '' }}" type="text" name="hour_close" id="hour_close" value="{{ old('hour_close', $docHotelReceptionInfo->hour_close) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('open_holiday') ? 'is-invalid' : '' }}" type="text" name="open_holiday" id="open_holiday" value="{{ old('open_holiday', $docHotelReceptionInfo->open_holiday) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('close_holiday') ? 'is-invalid' : '' }}" type="text" name="close_holiday" id="close_holiday" value="{{ old('close_holiday', $docHotelReceptionInfo->close_holiday) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('acces_type_after_hour') ? 'is-invalid' : '' }}" name="acces_type_after_hour" id="acces_type_after_hour">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('box_locate') ? 'is-invalid' : '' }}" name="box_locate" id="box_locate">{!! old('box_locate', $docHotelReceptionInfo->box_locate) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('acces_videoportero') ? 'is-invalid' : '' }}" name="acces_videoportero" id="acces_videoportero">{!! old('acces_videoportero', $docHotelReceptionInfo->acces_videoportero) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('external.doc-hotel-reception-infos.storeCKEditorImages') }}', true);
...
Dropzone.options.boxPhotoDropzone = {
    url: '{{ route('external.doc-hotel-reception-infos.storeMedia') }}',
    maxFilesize: 4, // MB
