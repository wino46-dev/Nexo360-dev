...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("external.doc-servicio-hotels.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('precio') ? 'is-invalid' : '' }}" type="number" name="precio" id="precio" value="{{ old('precio', '') }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('por_persona') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="por_persona" id="por_persona" value="1" {{ old('por_persona', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('por_dia') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="por_dia" id="por_dia" value="1" {{ old('por_dia', 0) == 1 ? 'checked' : '' }}>
