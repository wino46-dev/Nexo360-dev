...
@can('doc_info_hotel_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('external.doc-info-hotels.create') }}">
...
@can('doc_info_hotel_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('external.doc-info-hotels.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('external.doc-info-hotels.index') }}",
    columns: [
