...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("external.doc-info-hotels.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('exteriores') ? 'is-invalid' : '' }}" name="exteriores" id="exteriores">{!! old('exteriores') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitud') ? 'is-invalid' : '' }}" type="text" name="longitud" id="longitud" value="{{ old('longitud', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergencias') ? 'is-invalid' : '' }}" type="text" name="emergencias" id="emergencias" value="{{ old('emergencias', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('enlace_fotos') ? 'is-invalid' : '' }}" type="text" name="enlace_fotos" id="enlace_fotos" value="{{ old('enlace_fotos', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('aparcamiento') ? 'is-invalid' : '' }}" name="aparcamiento" id="aparcamiento">{!! old('aparcamiento') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('recomendaciones') ? 'is-invalid' : '' }}" name="recomendaciones" id="recomendaciones">{!! old('recomendaciones') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('horas_chekin') ? 'is-invalid' : '' }}" name="horas_chekin" id="horas_chekin">{!! old('horas_chekin') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cuenta_bancaria') ? 'is-invalid' : '' }}" type="text" name="cuenta_bancaria" id="cuenta_bancaria" value="{{ old('cuenta_bancaria', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('modos_cobro') ? 'is-invalid' : '' }}" type="text" name="modos_cobro" id="modos_cobro" value="{{ old('modos_cobro', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('datos_responsable') ? 'is-invalid' : '' }}" name="datos_responsable" id="datos_responsable">{!! old('datos_responsable') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('regional_manager') ? 'is-invalid' : '' }}" name="regional_manager" id="regional_manager">{!! old('regional_manager') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('revenue_manager') ? 'is-invalid' : '' }}" name="revenue_manager" id="revenue_manager">{!! old('revenue_manager') !!}</textarea>
