...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.docInfoHotel.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("external.doc-info-hotels.update", [$docInfoHotel->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('hotel') ? 'is-invalid' : '' }}" name="hotel_id" id="hotel_id" required>
                    @foreach($hotels as $id => $entry)
                        <option value="{{ $id }}" {{ (old('hotel_id') ? old('hotel_id') : $docInfoHotel->hotel->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('hotel'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" name="descripcion" id="descripcion">{!! old('descripcion', $docInfoHotel->descripcion) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('exteriores') ? 'is-invalid' : '' }}" name="exteriores" id="exteriores">{!! old('exteriores', $docInfoHotel->exteriores) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('categoria') ? 'is-invalid' : '' }}" name="categoria" id="categoria">
                    ...
                    @foreach(App\Models\DocInfoHotel::CATEGORIA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('categoria', $docInfoHotel->categoria) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('pais') ? 'is-invalid' : '' }}" name="pais_id" id="pais_id">
                    @foreach($pais as $id => $entry)
                        <option value="{{ $id }}" {{ (old('pais_id') ? old('pais_id') : $docInfoHotel->pais->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('pais'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('provincia') ? 'is-invalid' : '' }}" name="provincia_id" id="provincia_id">
                    @foreach($provincias as $id => $entry)
                        <option value="{{ $id }}" {{ (old('provincia_id') ? old('provincia_id') : $docInfoHotel->provincia->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ciudad') ? 'is-invalid' : '' }}" name="ciudad_id" id="ciudad_id">
                    @foreach($ciudads as $id => $entry)
                        <option value="{{ $id }}" {{ (old('ciudad_id') ? old('ciudad_id') : $docInfoHotel->ciudad->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('direccion') ? 'is-invalid' : '' }}" type="text" name="direccion" id="direccion" value="{{ old('direccion', $docInfoHotel->direccion) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codigo_postal') ? 'is-invalid' : '' }}" type="text" name="codigo_postal" id="codigo_postal" value="{{ old('codigo_postal', $docInfoHotel->codigo_postal) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitud') ? 'is-invalid' : '' }}" type="text" name="latitud" id="latitud" value="{{ old('latitud', $docInfoHotel->latitud) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('longitud') ? 'is-invalid' : '' }}" type="text" name="longitud" id="longitud" value="{{ old('longitud', $docInfoHotel->longitud) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $docInfoHotel->telefono) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergencias') ? 'is-invalid' : '' }}" type="text" name="emergencias" id="emergencias" value="{{ old('emergencias', $docInfoHotel->emergencias) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $docInfoHotel->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('web') ? 'is-invalid' : '' }}" type="text" name="web" id="web" value="{{ old('web', $docInfoHotel->web) }}">
                @if($errors->has('web'))
                    <div class="invalid-feedback">
                        {{ $errors->first('web') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('enlace_fotos') ? 'is-invalid' : '' }}" type="text" name="enlace_fotos" id="enlace_fotos" value="{{ old('enlace_fotos', $docInfoHotel->enlace_fotos) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('aparcamiento') ? 'is-invalid' : '' }}" name="aparcamiento" id="aparcamiento">{!! old('aparcamiento', $docInfoHotel->aparcamiento) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('recomendaciones') ? 'is-invalid' : '' }}" name="recomendaciones" id="recomendaciones">{!! old('recomendaciones', $docInfoHotel->recomendaciones) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('horas_chekin') ? 'is-invalid' : '' }}" name="horas_chekin" id="horas_chekin">{!! old('horas_chekin', $docInfoHotel->horas_chekin) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('observaciones') ? 'is-invalid' : '' }}" name="observaciones" id="observaciones">{!! old('observaciones', $docInfoHotel->observaciones) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cuenta_bancaria') ? 'is-invalid' : '' }}" type="text" name="cuenta_bancaria" id="cuenta_bancaria" value="{{ old('cuenta_bancaria', $docInfoHotel->cuenta_bancaria) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('modos_cobro') ? 'is-invalid' : '' }}" type="text" name="modos_cobro" id="modos_cobro" value="{{ old('modos_cobro', $docInfoHotel->modos_cobro) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('datos_responsable') ? 'is-invalid' : '' }}" name="datos_responsable" id="datos_responsable">{!! old('datos_responsable', $docInfoHotel->datos_responsable) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('regional_manager') ? 'is-invalid' : '' }}" name="regional_manager" id="regional_manager">{!! old('regional_manager', $docInfoHotel->regional_manager) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('revenue_manager') ? 'is-invalid' : '' }}" name="revenue_manager" id="revenue_manager">{!! old('revenue_manager', $docInfoHotel->revenue_manager) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('pet_friendly') ? 'is-invalid' : '' }}" name="pet_friendly" id="pet_friendly">
                    ...
                    @foreach(App\Models\DocInfoHotel::PET_FRIENDLY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('pet_friendly', $docInfoHotel->pet_friendly) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('external.doc-info-hotels.storeCKEditorImages') }}', true);
