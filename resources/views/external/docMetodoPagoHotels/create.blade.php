...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("external.doc-metodo-pago-hotels.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('activo') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="activo" id="activo" value="1" {{ old('activo', 0) == 1 ? 'checked' : '' }}>
