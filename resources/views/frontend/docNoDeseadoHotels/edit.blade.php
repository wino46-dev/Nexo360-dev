    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-no-deseado-hotels.update", [$docNoDeseadoHotel->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="datetime-local" id="fecha_dt" readonly onkeydown="return false" onclick="return false">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="datos_cliente" id="datos_cliente">{!! old('datos_cliente', $docNoDeseadoHotel->datos_cliente) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="no_deseado" id="no_deseado" value="1" {{ $docNoDeseadoHotel->no_deseado || old('no_deseado', 0) === 1 ? 'checked' : '' }}>
                                <label for="no_deseado">{{ trans('cruds.docNoDeseadoHotel.fields.no_deseado') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="motivo" id="motivo" value="{{ old('motivo', $docNoDeseadoHotel->motivo) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="comentarios" id="comentarios">{!! old('comentarios', $docNoDeseadoHotel->comentarios) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.doc-no-deseado-hotels.storeCKEditorImages') }}', true);
