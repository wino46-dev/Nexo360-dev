    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-no-deseado-hotels.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="datetime-local" id="fecha_dt">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="datos_cliente" id="datos_cliente">{!! old('datos_cliente') !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="no_deseado" id="no_deseado" value="1" {{ old('no_deseado', 0) == 1 ? 'checked' : '' }}>
