    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.dock-stock-hotels.update", [$dockStockHotel->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nombre">{{ trans('cruds.dockStockHotel.fields.nombre') }}</label>
                            <input class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre', $dockStockHotel->nombre) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cantidad" id="cantidad" value="{{ old('cantidad', $dockStockHotel->cantidad) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="comentarios" id="comentarios">{!! old('comentarios', $dockStockHotel->comentarios) !!}</textarea>
