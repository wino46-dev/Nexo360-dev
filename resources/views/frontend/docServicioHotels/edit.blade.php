    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-servicio-hotels.update", [$docServicioHotel->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre', $docServicioHotel->nombre) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="codigo" id="codigo" value="{{ old('codigo', $docServicioHotel->codigo) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="precio" id="precio" value="{{ old('precio', $docServicioHotel->precio) }}" step="0.01">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="por_persona" id="por_persona" value="1" {{ $docServicioHotel->por_persona || old('por_persona', 0) === 1 ? 'checked' : '' }}>
                                <label for="por_persona">{{ trans('cruds.docServicioHotel.fields.por_persona') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="por_dia" id="por_dia" value="1" {{ $docServicioHotel->por_dia || old('por_dia', 0) === 1 ? 'checked' : '' }}>
                                <label for="por_dia">{{ trans('cruds.docServicioHotel.fields.por_dia') }}</label>
                            </div>
