    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-habitacion-hotels.update", [$docHabitacionHotel->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre', $docHabitacionHotel->nombre) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="codigo" id="codigo" value="{{ old('codigo', $docHabitacionHotel->codigo) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="comentarios" id="comentarios">{!! old('comentarios', $docHabitacionHotel->comentarios) !!}</textarea>
