    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-hotel-reception-infos.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="hour_open" id="hour_open" value="{{ old('hour_open') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="hour_close" id="hour_close" value="{{ old('hour_close') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="open_holiday" id="open_holiday" value="{{ old('open_holiday') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="close_holiday" id="close_holiday" value="{{ old('close_holiday') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="box_locate" id="box_locate">{!! old('box_locate') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="acces_videoportero" id="acces_videoportero">{!! old('acces_videoportero') !!}</textarea>
