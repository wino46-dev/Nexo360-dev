        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.configuracionVideo.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.configuracion-videos.update", [$configuracionVideo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="totem_id" id="totem_id" required>
                                @foreach($totems as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('totem_id') ? old('totem_id') : $configuracionVideo->totem->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('totem'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sip_identity" id="sip_identity" value="{{ old('sip_identity', $configuracionVideo->sip_identity) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="display_name" id="display_name" value="{{ old('display_name', $configuracionVideo->display_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sip_registar" id="sip_registar" value="{{ old('sip_registar', $configuracionVideo->sip_registar) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username" id="username" value="{{ old('username', $configuracionVideo->username) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password" id="password" value="{{ old('password', $configuracionVideo->password) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sip_identity_destino" id="sip_identity_destino" value="{{ old('sip_identity_destino', $configuracionVideo->sip_identity_destino) }}">
