    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-hotel-estado-cajas.update", [$docHotelEstadoCaja->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="caja" id="caja" value="{{ old('caja', $docHotelEstadoCaja->caja) }}" step="1" required>
                            @if($errors->has('caja'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('caja') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $docHotelEstadoCaja->code) }}">
                            @if($errors->has('code'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('code') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cliente" id="cliente" value="{{ old('cliente', $docHotelEstadoCaja->cliente) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="documento_cliente" id="documento_cliente" value="{{ old('documento_cliente', $docHotelEstadoCaja->documento_cliente) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="comments" id="comments">{!! old('comments', $docHotelEstadoCaja->comments) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha" id="fecha" value="{{ old('fecha', $docHotelEstadoCaja->fecha) }}">
                            @if($errors->has('fecha'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fecha') }}
                                </div>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.doc-hotel-estado-cajas.storeCKEditorImages') }}', true);
