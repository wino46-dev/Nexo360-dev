    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-hotel-estado-cajas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="caja" id="caja" value="{{ old('caja', '') }}" step="1" required>
                            @if($errors->has('caja'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('caja') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cliente" id="cliente" value="{{ old('cliente', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="documento_cliente" id="documento_cliente" value="{{ old('documento_cliente', '') }}">
