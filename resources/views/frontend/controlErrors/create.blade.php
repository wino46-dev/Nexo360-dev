    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.control-errors.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="origen">{{ trans('cruds.controlError.fields.origen') }}</label>
                            <input class="form-control" type="text" name="origen" id="origen" value="{{ old('origen', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mensaje" id="mensaje" value="{{ old('mensaje', '') }}" required>
