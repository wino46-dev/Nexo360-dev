    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-metodo-pago-hotels.update", [$docMetodoPagoHotel->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre', $docMetodoPagoHotel->nombre) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="activo" id="activo" value="1" {{ $docMetodoPagoHotel->activo || old('activo', 0) === 1 ? 'checked' : '' }}>
