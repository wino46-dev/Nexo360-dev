    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.establecimientos.update", [$establecimiento->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="sociedad_id" id="sociedad_id" required>
                                @foreach($sociedads as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('sociedad_id') ? old('sociedad_id') : $establecimiento->sociedad->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="codigo" id="codigo" value="{{ old('codigo', $establecimiento->codigo) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre', $establecimiento->nombre) }}" required>
