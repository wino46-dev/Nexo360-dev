    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.ayuda-step-totems.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="eventos_push" id="eventos_push">{!! old('eventos_push') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="pase_imagenes" id="pase_imagenes">{!! old('pase_imagenes') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="captura_documentos" id="captura_documentos">{!! old('captura_documentos') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="pago_reserva" id="pago_reserva">{!! old('pago_reserva') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="grabacion_tarjeta" id="grabacion_tarjeta">{!! old('grabacion_tarjeta') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="parte_viajero" id="parte_viajero">{!! old('parte_viajero') !!}</textarea>
