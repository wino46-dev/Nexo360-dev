    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sociedads.update", [$sociedad->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="codigo">{{ trans('cruds.sociedad.fields.codigo') }}</label>
                            <input class="form-control" type="text" name="codigo" id="codigo" value="{{ old('codigo', $sociedad->codigo) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre', $sociedad->nombre) }}" required>
...
Dropzone.options.imagenesDropzone = {
    url: '{{ route('frontend.sociedads.storeMedia') }}',
    maxFilesize: 6, // MB
