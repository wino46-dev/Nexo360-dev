                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.clientes.update", [$cliente->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre', $cliente->nombre) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="apellidos" id="apellidos" value="{{ old('apellidos', $cliente->apellidos) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nif" id="nif" value="{{ old('nif', $cliente->nif) }}" required>
                            @if($errors->has('nif'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nif') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cod_postal" id="cod_postal" value="{{ old('cod_postal', $cliente->cod_postal) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $cliente->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
