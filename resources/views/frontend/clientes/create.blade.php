                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.clientes.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nif" id="nif" value="{{ old('nif', '') }}" required>
                            @if($errors->has('nif'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nif') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cod_postal" id="cod_postal" value="{{ old('cod_postal', '') }}">
