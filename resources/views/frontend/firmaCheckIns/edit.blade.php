    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.firma-check-ins.update", [$firmaCheckIn->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="firma_texto" id="firma_texto">{{ old('firma_texto', $firmaCheckIn->firma_texto) }}</textarea>
