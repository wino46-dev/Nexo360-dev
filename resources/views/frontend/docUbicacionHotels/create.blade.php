    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-ubicacion-hotels.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="piso" id="piso" value="{{ old('piso', '') }}" step="1">
                            @if($errors->has('piso'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('piso') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="zona_comun" id="zona_comun" value="1" {{ old('zona_comun', 0) == 1 ? 'checked' : '' }}>
