    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.check-ins.update", [$checkIn->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="llave" id="llave" value="{{ old('llave', $checkIn->llave) }}">
                            @if($errors->has('llave'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('llave') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="firma_checkin-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="firma_verificada" id="firma_verificada" value="1" {{ $checkIn->firma_verificada || old('firma_verificada', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="comentarios" id="comentarios">{!! old('comentarios', $checkIn->comentarios) !!}</textarea>
