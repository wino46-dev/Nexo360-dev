    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-info-hotels.update", [$docInfoHotel->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="descripcion" id="descripcion">{!! old('descripcion', $docInfoHotel->descripcion) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="exteriores" id="exteriores">{!! old('exteriores', $docInfoHotel->exteriores) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="direccion" id="direccion" value="{{ old('direccion', $docInfoHotel->direccion) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="codigo_postal" id="codigo_postal" value="{{ old('codigo_postal', $docInfoHotel->codigo_postal) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="latitud" id="latitud" value="{{ old('latitud', $docInfoHotel->latitud) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="longitud" id="longitud" value="{{ old('longitud', $docInfoHotel->longitud) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telefono" id="telefono" value="{{ old('telefono', $docInfoHotel->telefono) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="emergencias" id="emergencias" value="{{ old('emergencias', $docInfoHotel->emergencias) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $docInfoHotel->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="web" id="web" value="{{ old('web', $docInfoHotel->web) }}">
                            @if($errors->has('web'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('web') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="enlace_fotos" id="enlace_fotos" value="{{ old('enlace_fotos', $docInfoHotel->enlace_fotos) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="aparcamiento" id="aparcamiento">{!! old('aparcamiento', $docInfoHotel->aparcamiento) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="recomendaciones" id="recomendaciones">{!! old('recomendaciones', $docInfoHotel->recomendaciones) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="horas_chekin" id="horas_chekin">{!! old('horas_chekin', $docInfoHotel->horas_chekin) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="observaciones" id="observaciones">{!! old('observaciones', $docInfoHotel->observaciones) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cuenta_bancaria" id="cuenta_bancaria" value="{{ old('cuenta_bancaria', $docInfoHotel->cuenta_bancaria) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="modos_cobro" id="modos_cobro" value="{{ old('modos_cobro', $docInfoHotel->modos_cobro) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="datos_responsable" id="datos_responsable">{!! old('datos_responsable', $docInfoHotel->datos_responsable) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="regional_manager" id="regional_manager">{!! old('regional_manager', $docInfoHotel->regional_manager) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="revenue_manager" id="revenue_manager">{!! old('revenue_manager', $docInfoHotel->revenue_manager) !!}</textarea>
