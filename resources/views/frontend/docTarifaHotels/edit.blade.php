    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.doc-tarifa-hotels.update", [$docTarifaHotel->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tarifa" id="tarifa" value="{{ old('tarifa', $docTarifaHotel->tarifa) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="importe" id="importe" value="{{ old('importe', $docTarifaHotel->importe) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha" id="fecha" value="{{ old('fecha', $docTarifaHotel->fecha) }}">
                            @if($errors->has('fecha'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fecha') }}
                                </div>
